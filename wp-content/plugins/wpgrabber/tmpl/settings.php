...
<div class="tab-content" id="div_tab1"<?php echo $tab == 1 ? ' style="display: block;"' : ''; ?>>
    <fieldset>
        ...
        <tr>
            <td>Работа через прокси сервер (HTTP/HTTPS)</td>
            <td><input type="text" size="32" name="options[proxyServ]" value="<?php echo get_option('wpg_' .'proxyServ'); ?>" /> <i>Введите прокси в формате <strong>proxy:port</strong> (123.123.123.123:80)</i><br>Бесплатные прокси без авторизации - <strong><a href="https://checkerproxy.net" target="_blank">Здесь</a> (не долговечные)</strong></td>
        </tr>
        <tr>
            <td>Авторизация на прокси сервере</td>
            <td><input type="text" size="32" name="options[proxyAuth]" value="<?php echo get_option('wpg_' .'proxyAuth'); ?>" /> <br><i>Введите логин и пароль в формате <strong>login:password</strong> (vasya:1234567890)</i></td>
        </tr>
        <tr>
            <td>Сменить значение HTTP заголовка "User-Agent: "</td>
            <td><input type="text" size="96" name="options[userAgent]" value="<?php echo get_option('wpg_' .'userAgent'); ?>" /> <br><i>Задает значение HTTP заголовка "User-Agent: "</i> Найти User-Agent - <strong><a href="https://www.google.kz/search?ie=UTF-8&hl=ru&q=user%20agent%20list" target="_blank">Здесь</a></strong><br><strong>User-Agent поисковиков:</strong><br>GoogleBot - Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)<br>YandexBot - Mozilla/5.0 (compatible; YandexBot/3.0; +http://yandex.com/bots)<br>BingBot - Mozilla/5.0 (compatible; Bingbot/2.0; +http://www.bing.com/bingbot.htm)</td>
        </tr>
        </table>
    </fieldset>
     <fieldset>
...
<div class="tab-content" id="div_tab4"<?php echo $tab == 4 ? ' style="display: block;"' : ''; ?>>
    <fieldset>
        ...
        <tr>
            ...
            <b>Внимание!</b> Для работы данного метода обновления Вам потребуется настроить CRON-задание на Вашем сервере (хостинге) <a href="http://forum.wpgrabber.biz/viewtopic.php?f=2&t=7" target="_blank">( подробнее )</a>
            </div>
            </td>
        </tr>
        <tr>
