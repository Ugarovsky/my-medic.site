    ...
    <table class="tab-content-table">
        ...
        <div style="overflow: auto; height: 400px;">
            ...
            <table class="truser">
                ...
                <td><input size="15" type="text" name="params[usrepl][<?php echo $i; ?>][name]" value="<?php echo $row['params']['usrepl'][$i]['name']; ?>" /></td>
                <td><input size="50" type="text" name="params[usrepl][<?php echo $i; ?>][search]" value="<?php echo htmlspecialchars($row['params']['usrepl'][$i]['search']); ?>" /></td>
                ...
                <td><input style="text-align:center;" size="3" type="text" name="params[usrepl][<?php echo $i; ?>][limit]" value="<?php echo $row['params']['usrepl'][$i]['limit']; ?>" /></td>
                </tr>
                <?php } ?>
            </table>
        </div>
