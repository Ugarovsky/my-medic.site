	...
	<div class="content<?php if( !empty( $get_meta["tie_post_head_cover"][0] ) ) echo ' post-cover';?>">
		...
		<article <?php post_class('post-listing'); ?> id="the-post">
			...
			<?php endif; ?>
               ...
               <div align="right"><script src="//cdn.jsdelivr.net/npm/yandex-share2/share.js"></script>
<div class="ya-share2" data-services="vkontakte,facebook,twitter,odnoklassniki,moimir,gplus,skype,collections" data-counter=""></div></div>
