...
function arq_lite_facebook_count(){
	...
	elseif( empty($arq_lite_transient['facebook']) && !empty($arq_lite_data) && !empty( $arq_lite_options['data']['facebook'] )  ){
		...
		try {
			...
			$data 			= @arq_lite_remote_get( "https://graph.facebook.com/v2.7/$id?access_token=$access_token&fields=fan_count");
				...
				<div id="post-body-content" class="arq-lite-content">
					<div class="postbox">
						...
						<div class="inside">
							...
							<div><strong><?php _e( 'Need Help?' , 'tie' ) ?></strong><p><em><?php printf( __( 'Enter Your App ID and App Secret, <a href="%s" target="_blank">Click Here</a> For More Details.' , 'tie' ), 'https://themes.tielabs.com/docs/sahifa/#counter' ) ?></em></p></div>
							<div class="clear"></div>
						</div>
					</div> <!-- Box end /-->
...
elseif( isset( $_REQUEST['service'] ) && 'arq-dribbble' == $_REQUEST['service'] && $current_page == 'arqam_lite' ){
				...
				<div id="post-body-content" class="arq-lite-content">
					<div class="postbox">
						...
						<div class="inside">
							...
							<div><strong><?php _e( 'Need Help?' , 'tie' ) ?></strong><p><em><?php printf( __( 'Enter Your Facebook Page Name or ID and click on Get Access Token to get your App Access Token, <a href="%s" target="_blank">Click Here</a> For More Details.' , 'tie' ), 'https://themes.tielabs.com/docs/sahifa/#counter' ) ?></em></p></div>
							<div class="clear"></div>
						</div>
					</div> <!-- Box end /-->
